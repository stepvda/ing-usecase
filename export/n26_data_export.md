# Export des données N26 — Benchmark marketing ING vs concurrents

Document généré automatiquement à partir de `benchmark.db`, destiné à servir d'entrée à un autre pipeline (rapprochement avec les campagnes publicitaires réelles). Toutes les données ci-dessous concernent uniquement la banque N26 (code `N26`, segment : néobanque).
...
| Fiche produit | Termes de recherche N26 |
|---|---|
| Marques — néobanques (`marque_generique_neobanques`) | N26 |
...
262 points hebdomadaires, 1 termes, du 2021-09-12 au 2026-09-13. Fournies séparément dans **`n26_trends_data.csv`** (colonnes : product_id, product_label, term, bank, language, date, value) — non incluses ici pour garder ce document lisible.
...
|---|---|---|---|---|---|---|---|
| marque_generique_neobanques | N26 | 2022-04-24 | 5 | Pic isolé | 9.316 | 0.828 |  |
